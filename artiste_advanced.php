...
<html>
	...
	<body>
		...
		?>
		<hr>
        <p>Recherche d'un artiste par recherche avancée : </p>
        <form method="POST" action="artiste_advanced.php">
            <label>Nom</label> : <input type="text" name="nom"/>
            <label>Prénom</label> : <input type="text" name="prenom" />
            <label>Rôle</label> : <input type="text" name="role" />
            <label>Genre</label> : <input type="text" name="genre" />
            <label>Groupe d'origine</label> : <input type="text" name="groupe" />
        ...
        <?php
            ...
            // $genre = pg_escape_string($genre);
             //$groupe = pg_escape_string($groupe);
              ...
              WHERE (nom LIKE '%".$nom."%') AND (prenom LIKE '%".$prenom."%') AND (role LIKE '%".$role."%') AND (genre_pred LIKE '%".$genre."%') AND (groupe_a LIKE '%".$groupe."%')") or die(pg_last_error());
