...
<html>
	...
	<body>
		...
		?>
		<hr>
        <p><a href="artiste_advanced.php" >Vous cherchez un artiste?</a></p>
        <p><a href="group_advanced.php" >Vous cherchez un groupe?</a></p>
        <p><a href="album_advanced.php" >Vous cherchez un album?</a></p>
        <footer>
